...
print_r(array('prods' => $result, 'tot' => $cart->getTot(), 'clients' => isset($clients) ? $clients : '', 'client' => isset($client) ? $client : ''));
$template->display(array('prods' => $result, 'tot' => $cart->getTot(), 'clients' => isset($clients) ? $clients : '', 'client' => isset($client) ? $client : ''));
?>

...
<script type="text/javascript">
	var map;
	var TILE_SIZE = 256;
	var chicago = new google.maps.LatLng(45.402851, 11.929473);
	...
	function createInfoWindowContent() {
		...
		return ['Mela Rossa cash & carry', 'LatLng: ' + chicago.lat() + ' , ' + chicago.lng(), 'World Coordinate: ' + worldCoordinate.x + ' , ' + worldCoordinate.y, 'Pixel Coordinate: ' + Math.floor(pixelCoordinate.x) + ' , ' + Math.floor(pixelCoordinate.y), 'Tile Coordinate: ' + tileCoordinate.x + ' , ' + tileCoordinate.y + ' at Zoom Level: ' + map.getZoom()].join('<br>');
	}
